...
<%-- 		          
		          <p>${apartments.buyType } ${apartments.buyType =='매매'? apartments.salePrice: apartments.buyType=='전세'?apartments.rentDeposit : apartments.mRentPrice}만원</p>
              <c:choose>
                <c:when test="${apartments.buyType == '월세'}">
                  <p>월세보증금${apartments.mRentDeposit }만원</p>
                </c:when>
                <c:otherwise>
                  <p><br></p>
                </c:otherwise>              
