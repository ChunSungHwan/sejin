...
INSERT INTO COMPLEXES(ADDRESS,BLOCK_TOTAL,DOOR_TOTAL,PARK_TOTAL,HIGHEST_TIER,LOWEST_TIER,HEAT_SYSTEM,HEAT_FUEL,FLOOR_AREA_RATION,COMPANY_NAME,MOVE_DATE,COMPLETE_DATE)
VALUES ('서울 강남구 역삼동 716-3',3,247,397,25,1,'지역난방','열병합',257,'에스케이건설(주)',NOW(),NOW());
